...
namespace WebSampleBrowser.XlsIO
{
    public partial class FormatCells : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            #region Cell merging
            sheet.Range["F26:H28"].Merge();
            sheet.Range["D3:F3"].Merge();
            sheet.Range["B7:J8"].Merge();
            sheet.Range["F27"].RowHeight = 64;
            ...
            #region Insert Image
            sheet.Pictures.AddPicture(11, 4, XlsIOHelper.ResolveApplicationImagePath("EMPID1.png", Request), 55, 65);
            ...
            sheet.Range["F26:H28"].CellStyle.Borders.LineStyle = ExcelLineStyle.Medium;
            sheet.Range["F26:H28"].CellStyle.Borders[ExcelBordersIndex.DiagonalDown].ShowDiagonalLine = false;
            sheet.Range["F26:H28"].CellStyle.Borders[ExcelBordersIndex.DiagonalUp].ShowDiagonalLine = false;
