        ...
        "samples": [
               ...
               },
               {
                   ...
                   //second hierarchy
                         ...
                         { "id": "107", "name": "TIFF to PDF", "action": "TIFFtoPDF", "childcount": "0"},
                         { "id": "108", "name": "Image Extraction", "action": "ImageExtraction", "childcount": "0"},
                         { "id": "109", "name": "Export as Image", "action": "ExportasImage", "childcount": "0"}]
               },
               {
           ...
           { "id": "1", "name": "Default", "action": "DefaultFunctionalities", "childcount": "0" },
                          ...
                          },
                         {
                             "id": "4", "name": "Editing", "action": "ReplaceWithFormating", "childcount": "1", "samples": [
                                      ...
                                      { "id": "2", "name": "Bookmark Navigation", "action": "BookmarkNavigation","childcount": "0","type": "update" },
                         ...
                         },
                         {
                         ...
                         },
                          {
                             "id": "6", "name": "Mathematical Equation", "action": "Create Equation","childcount": "1", "samples": [
                                      { "id": "1", "name": "Create Equation", "controller": "DocIO", "action": "CreateEquation", "childcount": "0", "type": "update"},
                                      { "id": "2", "name": "Edit Equation", "controller": "DocIO", "action": "EditEquation", "childcount": "0", "type": "update"}
                             ]
                         },
                         {
                         ...
                         },
                         {
                             "id": "8", "name": "Insert Content", "action": "Bookmarks", "childcount": "1", "samples": [
                                      ...
                                      { "id": "4", "name": "Image Insertion", "action": "ImageInsertion", "childcount": "0","type": "update" },
                            ...
                            },
                            {
                             ...
                             },
                             {
                               "id": "17", "name": "Review", "action": "Track Changes", "childcount": "1", "samples": [                                        
                                        { "id": "1", "name": "Track Changes", "action": "TrackChanges", "childcount": "0","type": "new" },
                               ]
                           }
          ]
      },
			      ...
			      { "id": "3", "name": "Replace Options", "action": "ReplaceOptions", "childcount": "0" }
                      ...
                      },
                      {
                          "id": "8", "name": "Data Binding", "action": "ExternalConnection", "childcount": "1", "samples": [
                              ...
                              { "id": "8", "name": "Import HTML Table", "action": "HTMLToWorksheet", "childcount": "0", "type": "new" }
                          ]
                      },
                      {
                      ...
                      },
					  {
                          "id": "10", "name": "Export", "action": "ExcelToODS", "childcount": "1", "samples": [
							  ...
							  { "id": "5", "name": "Excel To JSON", "action": "ExcelToJSON",  "childcount": "0" "type": "new" }
                          ]
                      },
                      {
              ...
              },
              {
              ...
              },
               {
                  ...
                  //third hierarchy
						...
						{ "id": "45", "name": "OLE Object","action": "InsertOLEObject", "childcount": "0", "type": "update"},
