...
namespace WebSampleBrowser.PPTX
{
    public partial class Slides : System.Web.UI.Page
    {
        ...
        {
            Stream file1 = new FileStream(ResolveApplicationDataPath("Slides.pptx"), FileMode.Open, FileAccess.Read, FileShare.Read);
            ...
            presentation.Save("SlidesSample.pptx",FormatType.Pptx,Response);
